...
class LawyersPage extends StatelessWidget {
  late LawyerController controller;
  ...
  LawyersPage({Key? key, Map<String, String>? initFilter}) {
    controller = Get.find<LawyerController>();
    userController = Get.find<UserController>();
    settingController = Get.find<SettingController>();
    styleController = Get.find<Style>();
    colors = styleController.cardLawyerColors;
        ...
        child: Container(
          ...
          child: SafeArea(
            child: Column(
              children: [
                SearchSection(
                  filterSection: LawyerFilterSection(
