...
import 'package:dabel_sport/widget/filter_blogs.dart';
import 'package:dabel_sport/widget/grid_blog.dart';
...
class BlogsPage extends StatelessWidget {
  ...
  BlogsPage({Key? key, Map<String, String>? initFilter}) {
        ...
        child: Container(
          ...
          child: SafeArea(
            child: Column(
              children: [
                SearchSection(
                  filterSection: BlogFilterSection(
                    controller: controller,
                  ),
                  controller: controller,
