...
import 'package:dabel_sport/widget/filter_clubs.dart';
import 'package:dabel_sport/widget/grid_club.dart';
...
class ClubsPage extends StatelessWidget {
  ...
  ClubsPage({Key? key, Map<String, String>? initFilter}) {
    controller = Get.find<ClubController>();
    ...
    //     Get.to(
    //         ClubDetails(
    //             data:await  controller.find({'id': 23,'panel':'1'}),
    //
    //             colors: colors),
        ...
        child: Container(
          ...
          child: SafeArea(
            child: Column(
              children: [
                SearchSection(
                  filterSection: ClubFilterSection(
