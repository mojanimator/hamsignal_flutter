...
class NewItemPage extends StatelessWidget {
  ...
  NewItemPage({Key? key}) : super(key: key) {
    ...
    //     if (result == 'done') settingController.currentPageIndex = 4;
                    ...
                    ...items.keys
                        .map((e) => ShakeWidget(
                              child: Card(
                                ...
                                color:
                                    items[e]?['colors'][100]?.withOpacity(1.0),
                                elevation: 20,
                                margin: margin,
                                child: InkWell(
                                  onTap: () =>
                                                          ...
                                                          margin: EdgeInsets.symmetric(
                                                              vertical:
                                                                  styleController
                                                                      ...
                                                                      4),
                                                          child: Text(
                                                              "${el['key'].split('_')[1]} ${'month'.tr}: ${el['value'].split('').reversed.join('').replaceFirst('000', '000,').split('').reversed.join('')} ${'currency'.tr}"),
                                                          alignment:
                                                              Alignment.center,
                                                        ))
                                                    .toList(),
