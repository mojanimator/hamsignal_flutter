...
import 'package:dabel_sport/widget/filter_products.dart';
import 'package:dabel_sport/widget/grid_product.dart';
...
class ProductsPage extends StatelessWidget {
  ...
  ProductsPage({Key? key, Map<String, dynamic>  initFilter=const{}}) {
        ...
        child: Container(
          ...
          child: SafeArea(
            child: Column(
              children: [
                SearchSection(
                  filterSection: ProductFilterSection(
