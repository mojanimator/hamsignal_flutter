...
class ContractsPage extends StatelessWidget {
  ...
  ContractsPage({Key? key, Map<String, String>? initFilter}) {
    controller = Get.find<ContractController>();
    settingController = Get.find<SettingController>();
    userController = Get.find<UserController>();
    styleController = Get.find<Style>();
    colors = styleController.cardContractColors;
...
// ]),
        ...
        child: Container(
          ...
          child: SafeArea(
            child: Column(
              children: [
                SearchSection(
                  filterSection: ContractFilterSection(
      ...
      // floatingActionButtonContract: FloatingActionButtonContract.startFloat,
