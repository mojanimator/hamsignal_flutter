class Variables {
  ...
  static String LINK_COACH = "${DOMAIN}/coach";
  ...
  static String LINK_GET_BLOGS = "${APIDOMAIN}/blog/search";
  static String LINK_GET_PLAYERS = "${APIDOMAIN}/player/search";
  static String LINK_GET_COACHES = "${APIDOMAIN}/coach/search";
  ...
  static String LINK_EDIT_COACHES = "${APIDOMAIN}/coach/edit";
  ...
  static String LINK_CREATE_COACH = "${APIDOMAIN}/coach/create";
