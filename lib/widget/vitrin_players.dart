...
class VitrinPlayers extends StatelessWidget {
                    ...
                    child: Swiper(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          onTap: () => Get.to(
                              PlayerDetails(data: data[index], colors: colors),
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "${data[index].name} ${data[index].family} ",
