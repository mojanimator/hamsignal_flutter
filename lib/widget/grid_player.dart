...
class GridPlayer extends StatelessWidget {
          ...
          child: Card(
              ...
              child: ClipRRect(
                ...
                child: InkWell(
                  ...
                  onTap: () => Get.to(PlayerDetails(data: data.value, colors: colors),
                          transition: Transition.topLevel,
                          duration: Duration(milliseconds: 400))
                      ?.then((value) async {
                    data.value=value;
                    data.value.age=Player.getAge(data.value.born_at);
                  }),
                                          ...
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "${controller.getCounty(data.value.county_id)}",
                                                  style: titleStyle.copyWith(
                                                      fontWeight:
                                                          FontWeight.bold),
                                                ),
