...
class CoachFilterSection extends StatelessWidget {
                ...
                Center(
                  child: MyToggleButtons(
                    ...
                    children: [
                      ...
                      Container( padding: EdgeInsets.all(styleController.cardMargin),child: Text('man'.tr)),
                      Container( padding: EdgeInsets.all(styleController.cardMargin),child: Text('woman'.tr))
                    ],
                  ),
                ),
                Center(
